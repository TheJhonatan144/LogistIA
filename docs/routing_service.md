# Servicio de Ruteo OSM — LogistIA

## Objetivo

Este módulo implementa el servicio de ruteo para LogistIA. Permite calcular rutas desde una zona de origen hacia una o varias zonas destino usando servicios externos de mapas y, si estos fallan, una matriz local como respaldo.
